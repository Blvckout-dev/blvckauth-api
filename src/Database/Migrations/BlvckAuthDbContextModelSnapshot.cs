...
{
    [DbContext(typeof(BlvckAuthDbContext))]
    partial class BlvckAuthDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Blvckout.BlvckAuth.Database.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Blvckout.BlvckAuth.Database.Models.Scope", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Blvckout.BlvckAuth.Database.Models.UserScope", b =>
                {
                    b.HasOne("Blvckout.BlvckAuth.Database.Models.Scope", "Scope")
                        .WithMany()
                        .HasForeignKey("ScopeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Blvckout.BlvckAuth.Database.Models.User", "User")
                        .WithMany()
